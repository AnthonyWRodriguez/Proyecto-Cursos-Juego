...
case "BDD":
    ($logged)?
        include_once "controllers/BDD.control.php":
        mw_redirectToLogin($_SERVER["QUERY_STRING"]);
    die();
case "todos_cursos":
    ($logged)?
        include_once "controllers/todos_cursos.control.php":
        mw_redirectToLogin($_SERVER["QUERY_STRING"]);
    die();    
case "cursos_usuario":
    ($logged)?
        include_once "controllers/cursos_usuario.control.php":
        mw_redirectToLogin($_SERVER["QUERY_STRING"]);
    die(); 
case "curso_usuario":
    ($logged)?
        include_once "controllers/curso_usuario.control.php":
        mw_redirectToLogin($_SERVER["QUERY_STRING"]);
    die();    
case "nodo":
    ($logged)?
        include_once "controllers/nodo.control.php":
        mw_redirectToLogin($_SERVER["QUERY_STRING"]);
    die();     
}
...
case "logout":
    ...
    die();
case "historia":
    include_once "controllers/historia.control.php";
    die();
case "signin":
