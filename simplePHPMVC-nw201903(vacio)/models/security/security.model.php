...
function estaEnRol($usercod, $rolcod){
   $sqlstr = "select 1 as ok from roles_usuarios  where usercod = %d and rolescod = '%s';";
   $data = array();
...
function insertUsuarioSimple($userEmail, $timestamp, $password){
